...
This is the VB.NET version. We also offer a [C# version](https://github.com/AtalaSupport/DemoGallery_Desktop_DocumentAnnotationViewerDemo_CS_x64).
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_Desktop_DocumentAnnotationViewerDemo_VB_x64.git DocumentAnnotationViewerDemo --recursive
cd DocumentAnnotationViewerDemo
git submodule init
